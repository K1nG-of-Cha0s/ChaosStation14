...
[Website](N/A) | [Wiki](https://chaoswiki.chaosstation14.work/wikihome) | [Discord](N/A)
...
We are happy to accept contributions from anybody with competence. 

Make sure to read [CONTRIBUTING.md](/CONTRIBUTING.md) if you are new to ChaosStation13.75.

## AI-generated contributions disclaimer
This project does not like low-effort or fully AI-generated contributions. We can do that if we want, ourselves.
...
1. Clone this repo:
```shell
git clone https://github.com/K1nG-of-Cha0s/ChaosStation14.git
```
...
Most assets are licensed under [CC-BY-SA 3.0](https://creativecommons.org/licenses/by-sa/3.0/) unless stated otherwise. Assets have their license and the copyright in the metadata file. [Example](https://github.com/K1nG-of-Cha0s/ChaosStation14/blob/master/Resources/Textures/Objects/Tools/crowbar.rsi/meta.json).
